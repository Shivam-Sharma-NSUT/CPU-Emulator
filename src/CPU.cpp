...
void CPU::print(){
    ...
    std::cout << "**********************""**********************" << std::endl;
    std::cout << "**********************""**********************" << std::endl;
    std::cout << "************\tPC : " << PC.getData() << (PC.getData()<100?"\t":"") << "\t************" << std::endl;
    std::cout << "************\tDR : " << DR.getData() << (DR.getData()<100?"\t":"") << "\t************" << std::endl;
    std::cout << "************\tAR : " << AR.getData() << (AR.getData()<100?"\t":"") << "\t************" << std::endl;
    std::cout << "************\tAC : " << AC.getData() << (AC.getData()<100?"\t":"") << "\t************" << std::endl;
    std::cout << "************\tIR : " << IR.getData() << (IR.getData()<100?"\t":"") << "\t************" << std::endl;
